...
class CoPilotApp:
    ...
    def create_psk_monitor_tab(self, parent):
        ...
        ttk.Label(psk_activity_outer, text="DX! Priority Stn", font=('Arial', 8), foreground='red').pack(anchor=tk.W)
        ttk.Label(psk_activity_outer, text="DX2 New Entity", font=('Arial', 8), foreground='magenta').pack(anchor=tk.W)
